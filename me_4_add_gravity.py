...
while True:
	...
	for unit in player:
		if finale_speed >= 1:
			unit.forward(finale_speed)
			finale_speed = finale_speed * gravity
			print(finale_speed)
		...
		elif finale_speed < 1 and unit.ycor() < -300:
			speed = 0
...
# Идея для следующей игры и мое воплощение этой игры
# Нарисовать физику отражения
